    ...
    <div className="flex flex-col h-full">
      <div className="mb-8">
        ...
        <p className="page-subtitle">
          Share your Github, Certificate or CV
        </p>
      </div>
      ...
      <div
        ...
        className={`flex-1 min-h-[280px] border-2 border-dashed rounded-panel flex flex-col items-center justify-center cursor-pointer transition-all ${
          dragOver
            ? "border-klenz-orange bg-klenz-orange/5"
            : "border-klenz-border hover:border-klenz-muted/60 bg-klenz-elevated/40"
        }`}
      >
        ...
        <p className="text-xs text-klenz-muted mb-6">
          File you select will appear below.
        </p>
        <button
          type="button"
          onClick={(e) => {
      ...
      {files.length > 0 && (
        <div className="mt-6 space-y-2">
          {files.map(({ id, file }) => (
            <div
              key={id}
              className="panel-elevated px-4 py-3 flex items-center justify-between"
            >
              <div className="flex items-center gap-3 min-w-0">
                <UploadIcon
                  className="w-4 h-4 text-klenz-orange shrink-0"
                  active
                />
              ...
              <button
                ...
                className="text-klenz-muted hover:text-red-400 text-sm ml-2"
              >
                Remove
              </button>
            </div>
      ...
      <div className="flex justify-end mt-8">
        ...
        >
          {loading ? (
            ...
            <UploadIcon className="w-4 h-4" active />
          )}
