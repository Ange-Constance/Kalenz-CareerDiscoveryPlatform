...
const steps = [
  {
    ...
    title: "Upload CV",
    description:
      "Drop your PDF or Word CV — we extract skills and discard the file.",
    Icon: UploadStepIcon,
  },
  {
    num: "2",
    ...
    description:
      "Our ML model ranks you across 5 tech career paths with confidence scores.",
  ...
  },
  {
    ...
    description:
      "View your roadmap, career matches, and chat with your AI advisor.",
    Icon: PathStepIcon,
  },
];
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(255,140,0,0.35) 0%, transparent 70%)",
          top: "-10%",
          right: "5%",
        }}
      />
...
function FAQItem({ question, answer, isOpen, onToggle }) {
  return (
    <div className="border-b border-klenz-border last:border-0">
      ...
      {isOpen && (
        <p className="text-sm text-klenz-muted pb-5 leading-relaxed animate-fade-in">
          {answer}
        </p>
      )}
    </div>
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-klenz-black overflow-x-hidden page-enter">
        ...
        <div className="content-container relative z-10">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            <p className="text-klenz-muted text-base sm:text-lg mb-10 max-w-[520px] leading-relaxed">
              AI-powered career discovery built for Rwandan tech graduates
              upload your CV, get matched to the right path, and explore your
              future.
            </p>
      ...
      <section
        id="how-it-works"
        className="section-spacing bg-klenz-surface/50"
      >
        <div className="content-container">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            {steps.map(({ num, title, description, Icon }) => (
              <div
                key={title}
                className="card card-glow text-center p-6 lg:p-8"
              >
                <div className="text-4xl font-extrabold text-klenz-orange mb-4">
                  {num}
                </div>
                ...
                <p className="text-sm text-klenz-muted leading-relaxed">
                  {description}
                </p>
              </div>
            ))}
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-klenz-muted text-sm leading-relaxed mb-8 max-w-md">
                Ask anything about your career path, skills to learn, companies
                hiring in Rwanda, or how to build your portfolio.
              </p>
            ...
            <div className="card card-purple p-5 sm:p-6 space-y-3">
              <div className="flex justify-start animate-slide-up">
                <div className="chat-bubble-ai max-w-[90%] px-4 py-3 text-sm leading-relaxed">
                  Hi! I&apos;ve analyzed your CV. You&apos;re a great fit for
                  Data &amp; AI. Want to know what skills to learn first?
                </div>
              </div>
              <div
              ...
              >
                <div className="chat-bubble-ai max-w-[90%] px-4 py-3 text-sm leading-relaxed">
                  Start with Python and SQL fundamentals, then move to
                  scikit-learn. Here&apos;s a 3-month roadmap...
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="faq" className="section-spacing">
        <div className="content-container max-w-3xl">
          <div className="text-center mb-10">
            ...
            <p className="text-klenz-muted text-sm">
              Everything you need to know about KarrerLenz
            </p>
          </div>
